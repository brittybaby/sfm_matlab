...
clear all;
close all;
I1 = imread('G:/Backup/projects/Matlab/Round_table/im3.bmp');
I2 = imread('G:/Backup/projects/Matlab/Round_table/im4.bmp');
...
load G:/Backup/projects/Matlab/Calibration_25_Nov/calibrationSession_25_Nov_2.mat
...
[E, epipolarInliers] = estimateEssentialMatrix(...
    matchedPoints1, matchedPoints2, cameraParameters, 'Confidence', 99.99);
...
[orient, loc] = relativeCameraPose(E, cameraParameters, inlierPoints1, inlierPoints2);
