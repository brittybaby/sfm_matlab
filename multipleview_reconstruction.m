...
imageDir = fullfile('/home/nets/projects/Matlab/Multi_view_sample_endo/');
...
load(fullfile(imageDir, 'calibrationSession_25_Nov_2.mat'));

%load(fullfile(imageDir), );
...
for i = 2:numel(images)
    ...
    I = undistortImage(images{i}, cameraParameters);
    ...
    [relativeOrient, relativeLoc, inlierIdx] = helperEstimateRelativePose(...
        matchedPoints1, matchedPoints2, cameraParameters);
    ...
    xyzPoints = triangulateMultiview(tracks, camPoses, cameraParameters);
    
    % Refine the 3-D world points and camera poses.
    [xyzPoints, camPoses, reprojectionErrors] = bundleAdjustment(xyzPoints, ...
        tracks, camPoses, cameraParameters, 'FixedViewId', 1, ...
...
[xyzPoints, camPoses, reprojectionErrors] = bundleAdjustment(...
    xyzPoints, tracks, camPoses, cameraParameters, 'FixedViewId', 1, ...
    'PointsUndistorted', true);
