...
for i = 1:numImages
    ...
    files{i} = fullfile('/home/nets/projects/Matlab/Calibration_25_Nov', sprintf('image%d.jpg', i));
    else
     files{i} = fullfile('/home/nets/projects/Matlab/Calibration_25_Nov', sprintf('image%d.bmp', i)); 
    end
end
...
imOrig = imread('/home/nets/projects/Matlab/Calibration_25_Nov/image23.bmp');
...
imCoin = (saturation > 0.7);


se = strel('cube',5);

imCoin = imerode(imCoin, se);

se1 = strel('sphere',10);
imCoin = imdilate(imCoin, se1);
...
imDetectedCoins = insertObjectAnnotation(imOrig, 'rectangle', ...
     boxes, 'penny');
...
% far away it is from the camera. 
